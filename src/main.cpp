...
"   <body>\n"
"       <h1>EKI Telemetry</h1>\n"
"       <span id='telemetry'><ul class='striped-list'>";
...
"               var date = fields[8];\n"
"               document.getElementById('telemetry').innerHTML += '<li>Date: ' +\n"
"                   date + '</li>\\n';\n"
"               var time = fields[9];\n"
"               document.getElementById('telemetry').innerHTML += '<li>Time: ' +\n"
"                   time + '</li>\\n';\n"
"               var position = fields[10].split('=')[1];\n"
"               var lat = position.split(',')[0];\n"
"               var lon = position.split(',')[1];\n"
"               document.getElementById('telemetry').innerHTML += '<li>Position: ' +\n"
"                   \"<a href='http://maps.google.com/maps?z=14&t=m&q=loc:\" +\n"
"                   lat + '+' + lon + \"'> \" + position + \"</a> </li>\\n\";\n"
"               var altitude = fields[3].split('=')[1];\n"
"               document.getElementById('telemetry').innerHTML += '<li>Altitude: ' +\n"
"                   altitude + ' m </li>\\n';\n"
"               var speed = fields[2];\n"
"               document.getElementById('telemetry').innerHTML += '<li>Speed: ' +\n"
"                   altitude + ' kn </li>\\n';\n"
"               var heading = fields[1].split('O')[1];\n"
"               document.getElementById('telemetry').innerHTML += '<li>Heading: ' +\n"
"                   heading + ' º <br />\\n';\n"
"               var bat = fields[4].split('=')[1];\n"
"               document.getElementById('telemetry').innerHTML += '<li>Battery: ' +\n"
"                   altitude + ' V </li>\\n';\n"
"           }\n"
"       </script>\n"
"   </body>\n"
